...
const VideoInfos = ({ video }) => {
  return (
    <div className="video-infos-container flex flex-col gap-y-5 py-3 px-5">
      <div className="title font-bold text-2xl	">Cooking chinese food</div>
        ...
        <div className="channel flex gap-5 flex-nowrap items-center">
          <div className="channel-img ">
            <img
              ...
              alt="channel"
              className="w-20 h-20 rounded-full border-[3px] border-pink-700 border-solid"
            />
          </div>
          <div className="flex flex-col justify-around">
            <div className="channel-name font-bold text-[20px]">Asian Food</div>
            <div className="channel-subscribers text-[20px]">32.3K subs</div>
          </div>
        </div>
        <div className="subscribe-btn">
          <button
            type="button"
            class=" focus:outline-none text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg px-5 py-2 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-900 text-[20px]"
          >
            Subscribe
          </button>
        </div>
