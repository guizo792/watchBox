...
const VideoInfos = ({ video }) => {
  return (
    <div className="video-infos-container flex flex-col gap-y-5 py-3 px-5">
      <div className="title font-medium text-xl	">Cooking chinese food</div>
      <div className="other-infos flex gap-5 items-center justify-around basis-1 flex-wrap">
        ...
        <div className="subscribe-btn">
          <button
            type="button"
            class=" focus:outline-none text-white bg-pink-700 hover:bg-pink-800 focus:ring-4 focus:ring-pink-300 rounded-lg px-3 py-1 dark:bg-pink-600 dark:hover:bg-pink-700 dark:focus:ring-pink-900 text-[20px]"
          >
            Subscribe
          </button>
        </div>
        <div className="like-dislike flex gap-2 flex-nowrap	">
          ...
          >
            ...
            <span className="text-[18px]">34k</span>
          </button>
          <button
            title="Dislike"
          ...
          >
            ...
            <span className="text-[18px]">1k</span>
          </button>
        </div>
